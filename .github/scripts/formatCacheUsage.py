...
def generate_cache_usage_html():
    html = "<html>"
    html += "<body><h1 style=\"margin-bottom:0px;\">Performance Profiling</h1><details><summary><h3 style=\"display:inline; margin-bottom:0px;\">Cache Memory Usage</h3></summary><ul>"
